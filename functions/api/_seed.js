/* ============================================================
   _seed.js — المهام الافتراضية (تُزرع في D1 مرة واحدة عند الإعداد)
   مولَّد آلياً من js/data.js + js/admin-data.js
   ============================================================ */
...
export const DEFAULT_TASKS = [
 {
  ...
  "payload": {
   ...
   "ar": [
    "تأكيد موعد عميل",
    "اجمع بيانات الموعد وسيصيغ لك المساعد رسالة التأكيد المعتمدة"
   ],
   "en": [
    "Confirm client appointment",
    "Collect appointment data; the assistant drafts the approved confirmation message"
   ],
   "steps": 3,
   "fields": [
    {
    ...
    {
     "k": "day",
     "ar": "يوم وتاريخ الموعد",
     "en": "Appointment day & date",
     "type": "text"
    },
    {
     "k": "service",
 ...
 },
 {
  ...
  "payload": {
   ...
   "ar": [
    "رد على استفسار عميل",
    "المساعد يلزمك بجمع سياق الاستفسار كاملاً قبل صياغة الرد"
   ],
   "en": [
    "Reply to client inquiry",
    "The assistant requires the full inquiry context before drafting a reply"
   ],
   "steps": 3,
   "fields": [
    {
    ...
    {
     "k": "question",
     "ar": "نص استفسار العميل",
     "en": "Client question text",
     "type": "textarea"
    },
    {
     "k": "client",
 ...
 },
 {
  ...
  "payload": {
   ...
   "ar": [
    "تقرير نهاية اليوم",
    "لا يقبل المساعد التقرير إلا مكتمل الأرقام الأساسية"
   ],
   "en": [
    "End-of-day report",
    "The assistant only accepts the report with all core numbers"
   ],
   "steps": 4,
   "fields": [
    {
     "k": "visits",
     "ar": "عدد الزيارات اليوم",
     "en": "Visits today",
     "type": "text"
    },
    {
    ...
    {
     "k": "issues",
     "ar": "أهم ملاحظة أو مشكلة",
     "en": "Key note or issue",
     "type": "textarea"
    }
   ],
   "result": {
 ...
 },
 {
  ...
  "payload": {
   ...
   "ar": [
    "كتابة بوست سوشيال",
    "المساعد يلزمك بتحديد الخدمة والجمهور والهدف قبل أي صياغة"
   ],
   "en": [
    "Write a social post",
    "The assistant requires service, audience and goal before drafting"
   ],
   "steps": 3,
   "fields": [
    {
     "k": "service",
     "ar": "الخدمة موضوع البوست",
     "en": "Service of the post",
     "type": "text"
    },
    {
     "k": "audience",
 ...
 },
 {
  ...
  "payload": {
   ...
   "ar": [
    "فكرة فيديو قصير",
    "اجمع عناصر الفكرة وسيبني لك المساعد سيناريو مبدئياً"
   ],
   "en": [
    "Short video idea",
    "Provide the idea elements; the assistant builds an initial script"
   ],
   "steps": 3,
   "fields": [
    {
 ...
 },
 {
  ...
  "payload": {
   ...
   "icon": "📅",
   "ar": [
    "جدولة بوستات الأسبوع",
    "حدّد المنصة والعدد والمحور وسيبني لك المساعد جدولاً مبدئياً"
   ],
   "en": [
    "Schedule weekly posts",
    "Set platform, count and theme; the assistant builds an initial schedule"
   ],
   "steps": 3,
   "fields": [
    {
    ...
    {
     "k": "count",
     "ar": "عدد البوستات المطلوبة",
     "en": "Number of posts",
     "type": "text"
    },
    {
     "k": "theme",
     "ar": "المحور الأساسي للأسبوع",
     "en": "Main theme of the week",
     "type": "text"
    }
   ],
   "result": {
 ...
 },
 {
  ...
  "payload": {
   ...
   "icon": "💬",
   "ar": [
    "رد على تعليق أو رسالة",
    "المساعد يطلب نص التعليق ونبرة الرد قبل الصياغة"
   ],
   "en": [
    "Reply to a comment or DM",
    "The assistant requires the comment text and reply tone before drafting"
   ],
   "steps": 3,
   "fields": [
    {
    ...
    {
     "k": "comment",
     "ar": "نص التعليق / الرسالة",
     "en": "Comment / message text",
     "type": "textarea"
    },
    {
     "k": "tone",
 ...
 },
 {
  ...
  "payload": {
   ...
   "icon": "🌐",
   "ar": [
    "طلب تحديث محتوى صفحة",
    "حدّد الصفحة والقسم والتعديل المطلوب بدقة قبل التنفيذ"
   ],
   "en": [
    "Page content update request",
    "Specify the page, section and exact change before execution"
   ],
   "steps": 3,
   "fields": [
    {
     "k": "page",
     "ar": "الصفحة (الاسم أو الرابط)",
     "en": "Page (name or URL)",
     "type": "text"
    },
    {
     "k": "section",
     "ar": "القسم المطلوب تعديله",
     "en": "Section to modify",
     "type": "text"
    },
    {
     "k": "change",
     "ar": "وصف التعديل المطلوب",
 ...
 },
 {
  ...
  "payload": {
   ...
   "ar": [
    "إضافة منتج للمتجر",
    "المساعد يلزمك ببيانات المنتج كاملة قبل صياغة بطاقته"
   ],
   "en": [
    "Add a store product",
    "The assistant requires complete product data before drafting its card"
   ],
   "steps": 3,
   "fields": [
    {
 ...
 },
 {
  ...
  "payload": {
   ...
   "ar": [
    "طلب توريد مخزون",
    "حدّد الصنف والكمية ودرجة الاستعجال ليخرج الطلب بالتنسيق المعتمد"
   ],
   "en": [
    "Stock supply request",
    "Set item, quantity and urgency to produce the approved request format"
   ],
   "steps": 3,
   "fields": [
    {
 ...
 },
 {
  ...
  "payload": {
   ...
   "ar": [
    "تقرير جرد صنف",
    "المساعد لا يقبل الجرد بلا كمية فعلية وملاحظات الفروقات"
   ],
   "en": [
    "Item stock-count report",
    "The assistant requires the counted quantity and variance notes"
   ],
   "steps": 3,
   "fields": [
    {
 ...
 },
 {
  ...
  "payload": {
   ...
   "ar": [
    "تقرير حضور يومي",
    "لا يكتمل التقرير إلا بأرقام الحضور والغياب وملاحظاتها"
   ],
   "en": [
    "Daily attendance report",
    "The report requires presence/absence numbers and notes"
   ],
   "steps": 3,
   "fields": [
    {
    ...
    {
     "k": "notes",
     "ar": "ملاحظات (تأخير · استئذان...)",
     "en": "Notes (lateness · permissions...)",
     "type": "textarea"
    }
   ],
   "result": {
 ...
 },
 {
  ...
  "payload": {
   ...
   "ar": [
    "مسودة إعلان وظيفة",
    "حدّد المسمى والقسم والمتطلبات ليصيغ المساعد الإعلان"
   ],
   "en": [
    "Job posting draft",
    "Set title, department and requirements; the assistant drafts the posting"
   ],
   "steps": 3,
   "fields": [
    {
 ...
 },
 {
  ...
  "payload": {
   ...
   "ar": [
    "تسجيل مصروف",
    "المساعد لا يسجّل مصروفاً بلا وصف ومبلغ وتصنيف"
   ],
   "en": [
    "Record an expense",
    "The assistant requires description, amount and category"
   ],
   "steps": 3,
   "fields": [
    {
 ...
 },
 {
  ...
  "payload": {
   ...
   "ar": [
    "تقرير تحصيل يومي",
    "لا يكتمل التقرير إلا بمجاميع النقدي والشبكة والملاحظات"
   ],
   "en": [
    "Daily collections report",
    "The report requires cash and card totals plus notes"
   ],
   "steps": 3,
   "fields": [
    {
    ...
    {
     "k": "card",
     "ar": "إجمالي الشبكة / التحويلات",
     "en": "Card / transfers total",
     "type": "text"
    },
    {
     "k": "notes",
